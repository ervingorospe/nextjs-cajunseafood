...
export async function DefaultCustom({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative overflow-hidden bg-gradient-to-r from-primary-600 to-primary-500 xl:from-primary-700 xl:to-primary-500" bg={bg}>
      <div 
      ...
      <div className="relative bg-transparent pb-20 sm:pb-24 xl:pb-0">
